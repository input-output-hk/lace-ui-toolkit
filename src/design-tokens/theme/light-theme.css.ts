...
const colors: Colors = {
  ...
  $focused_outline: lightColorScheme.$primary_accent_purple_0_3,
  ...
  $text_dark_grey: lightColorScheme.$primary_dark_grey,
  ...
  $select_grey_bgColor_rest: lightColorScheme.$primary_light_grey,
  $select_grey_bgColor_hover: lightColorScheme.$primary_light_grey_plus,
  $select_grey_bgColor_pressed: lightColorScheme.$primary_light_grey_plus,
  $select_grey_content_bgColor: lightColorScheme.$primary_light_grey,
  $select_plain_bgColor_rest: lightColorScheme.$primary_white,
  $select_plain_bgColor_hover: lightColorScheme.$primary_light_grey,
  $select_plain_bgColor_pressed: lightColorScheme.$primary_light_grey,
  $select_plain_content_bgColor: lightColorScheme.$primary_white,
  $select_outline_bgColor_rest: lightColorScheme.$primary_white,
  $select_outline_bgColor_hover: lightColorScheme.$primary_light_grey,
  $select_outline_bgColor_pressed: lightColorScheme.$primary_light_grey,
  $select_outline_border_color: lightColorScheme.$primary_light_grey_plus,
  $select_outline_content_bgColor: lightColorScheme.$primary_white,
  $select_text_color: lightColorScheme.$primary_black,
  $select_placeholder_text_color: lightColorScheme.$primary_dark_grey,
